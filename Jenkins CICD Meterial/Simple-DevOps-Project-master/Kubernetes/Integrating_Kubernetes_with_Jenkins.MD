...
#### From Jenkins home page select "New Item"
   ...
   - *Source Code Management:*
      - Repository: `https://github.com/harikrishnacheruku866/hello-world.git`
  ...
  - *Post-build Actions*  
    - Send build artifacts over SSH  
      - *SSH Publishers*  
	       - Exec command: 
                ```sh 
                ansible-playbook -i /opt/docker/hosts /opt/docker/kubernetes-blujay-deployment.yml;
                ansible-playbook -i /opt/docker/hosts /opt/docker/kubernetes-blujay-service.yml;
                ```
Save and run the job.
